...
{
    public new static readonly Guid Guid = new("0d8fdcaa-6257-47bf-b1bf-94dac88466ee");

    HResult EnumThreads(out nint ppEnum);
     ...
     */
    HResult EnumJITedFunctions2(out nint ppEnum);
