...
public unsafe interface IMetaDataImport : IUnknown
{
    ...
    HResult ResolveTypeRef(MdTypeRef tr, in Guid riid, out nint iScope, out MdTypeDef ptd);
    ...
    HResult GetPermissionSetProps(
        ...
        out nint ppvPermission,        // [OUT] permission blob.
    ...
    HResult GetNameFromToken(            // Not Recommended! May be removed!
        ...
        out nint pszUtf8NamePtr);  // [OUT] Return pointer to UTF8 name in heap.
    ...
    HResult GetCustomAttributeProps(
        ...
        out nint ppBlob,               // [OUT, OPTIONAL] Put pointer to data here.
    ...
    HResult GetMemberProps(
        ...
        out nint ppValue,             // [OUT] constant value
    ...
    HResult GetPropertyProps(            // S_OK, S_FALSE, or error.
        ...
        out uint pdwCPlusTypeFlag,      // [OUT] flag for value type. selected ELEMENT_TYPE_*
        out nint ppDefaultValue,      // [OUT] constant value
    ...
    HResult GetCustomAttributeByName(
        ...
        out nint ppData,               // [OUT] Put pointer to data here.
