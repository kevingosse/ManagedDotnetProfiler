...
internal unsafe interface ICorProfilerInfo9 : ICorProfilerInfo8
{
    ...
    HResult GetILToNativeMapping3(IntPtr nativeCodeStartAddress, uint cMap, out uint pcMap, COR_DEBUG_IL_TO_NATIVE_MAP* map);
    ...
    HResult GetCodeInfo4(IntPtr nativeCodeStartAddress, uint cCodeInfos, out uint pcCodeInfos, COR_PRF_CODE_INFO* codeInfos);
}