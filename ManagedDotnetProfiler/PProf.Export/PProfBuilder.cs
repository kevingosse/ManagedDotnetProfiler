...
namespace Datadog.PProf.Export
{
    internal sealed class PProfBuilder
    {
        ...
        public PProfBuilder()
        {
            ...
            this.SampleValueTypes = new PProfSampleValueType[3];
            this.SampleValueTypeInfos = new PProfInfo.ValueType[3];
            this.SampleValuesUnset = new long[3];
        }
                ...
                out PProfInfo.Location locationInfo)
        {
            ...
            var functionName = locationDescriptor.Function;
            var classTypeName = locationDescriptor.Type;
            var namespaceName = locationDescriptor.Ns;
            var binaryContainerName = locationDescriptor.Module;
            var binaryContainerVersion = "";
                        ...
                        out string binaryContainerMoniker)
        {
            ...
            name.Append(SymbolMonikersConfig.PrefixNamespaceName);
            ...
            Console.WriteLine(functionMoniker);
        }
    }
}
