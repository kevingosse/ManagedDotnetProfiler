...
namespace Datadog.PProf.Export
{
    internal class PProfItemCache : IDisposable
    {
        ...
        private readonly Dictionary<StackFrame, PProfInfo.Location> _locations = new();
        ...
        public bool TryGetLocationInfo(StackFrame locationDescriptor, out PProfInfo.Location locationInfo)
        {
